      ...
      <main className="flex-grow">
        <section className="relative py-24 md:py-40">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Suboor loadboard is the intelligent loadboard connecting shippers and carriers with live tracking, unparalleled cargo security, and a network of verified professionals.
            </p>
        ...
        <section id="features" className="py-16 md:py-24 bg-card border-y">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h3 className="text-2xl md:text-3xl font-headline font-semibold mb-4">For Everyone: The Suboor loadboard Verified Network</h3>
                        <p className="text-muted-foreground text-lg">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <Card>
                        <CardContent className="p-6">
                            ...
                            <p className="text-muted-foreground italic">&ldquo;The Red Alert system is a game-changer. For the first time, we have true peace of mind. We only book carriers with the Suboor loadboard sensor now.&rdquo;</p>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardContent className="p-6">
      ...
      <footer className="bg-background border-t">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:flex md:items-center md:justify-between">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
                 <p className="text-center text-base text-muted-foreground">&copy; {new Date().getFullYear()} Suboor loadboard. All rights reserved.</p>
            </div>
        </div>
      </footer>
    </div>
